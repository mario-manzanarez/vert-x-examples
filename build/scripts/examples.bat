...
set CLASSPATH=%APP_HOME%\lib\examples-1.0.0-SNAPSHOT.jar;%APP_HOME%\lib\bcpkix-jdk15on-1.70.jar;%APP_HOME%\lib\bcutil-jdk15on-1.70.jar;%APP_HOME%\lib\bcprov-jdk15on-1.70.jar;%APP_HOME%\lib\vertx-web-client-4.3.7.jar;%APP_HOME%\lib\vertx-web-validation-4.3.7.jar;%APP_HOME%\lib\vertx-web-4.3.7.jar;%APP_HOME%\lib\vertx-pg-client-4.3.7.jar;%APP_HOME%\lib\log4j-slf4j-impl-2.17.2.jar;%APP_HOME%\lib\vertx-web-common-4.3.7.jar;%APP_HOME%\lib\vertx-auth-common-4.3.7.jar;%APP_HOME%\lib\vertx-bridge-common-4.3.7.jar;%APP_HOME%\lib\vertx-uri-template-4.3.7.jar;%APP_HOME%\lib\vertx-json-schema-4.3.7.jar;%APP_HOME%\lib\vertx-sql-client-4.3.7.jar;%APP_HOME%\lib\vertx-core-4.3.7.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.86.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.86.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.86.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.86.Final.jar;%APP_HOME%\lib\netty-handler-4.1.86.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.86.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.86.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.86.Final.jar;%APP_HOME%\lib\netty-codec-4.1.86.Final.jar;%APP_HOME%\lib\netty-transport-4.1.86.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.86.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.86.Final.jar;%APP_HOME%\lib\netty-common-4.1.86.Final.jar;%APP_HOME%\lib\jackson-core-2.14.0.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\log4j-core-2.17.2.jar;%APP_HOME%\lib\log4j-api-2.17.2.jar


@rem Execute examples
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLES_OPTS%  -classpath "%CLASSPATH%" io.vertx.core.Launcher %*
